...
**interpretation:** This plot serves to evaluate the accuracy of the replicated model in predicting the relationship between the growth of county crime rates and county dispensary density growth, while controlling for poverty rate, racial demographics, and employment rate.
...
Additionally, the high p-value (0.95) indicates that we can not reject the null hypothesis that dispensary presence has no effect on crime rates.
