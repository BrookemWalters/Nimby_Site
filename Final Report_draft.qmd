...
-   comparing soccio-ecconmic factors:
    ...
    ![NIMBY's Version](images/Table1(cropped).jpg){width="495"}

    ![Replicated Version](images/Rplot.jpeg){width="494"}
