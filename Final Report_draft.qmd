...
![**how to read:** the three year average of crimes per 10,000 residents are plotted by Colorado county, overlaid by the three year average count of dispensaries with in the county.](images/co_map.png)

**interpretation:** Denver is clearly where we see the larger crime rates, and more dispensaries. NIMBY referrs to Devver as the "mecca of recreational cannabis." El Paso is an interesting county with a relativity high dispensary density and low crime rate, as well as Montrose county where the inverse is true.
