...
I outline my methodology in more detail under the outlined categories in this site's navigation bar. In summation, here's how I approached this project:

-   Processed 700 dispensary business records into a single dataframe \| [code](https://brookemwalters.github.io/Nimby_Site/counting_dispensaries_step1.html "Counting Dispensaries")

-   Cross compared socioeconomic factors next to dispensary growth rates \| [code](https://brookemwalters.github.io/Nimby_Site/Label%20the%20Dispensaries%20with%20GeoCodes_step2.html "Geocodes, Census Variables, and Dispensaries Per Capita")

-   Calculated dispensaries and crime per capita \| [code](https://brookemwalters.github.io/Nimby_Site/calculate%20crime%20and%20dispensaries%20per%20capita_step3.html "per capita")

-   Created a linear model regression model exploring the relationship between these variables \| [code](https://brookemwalters.github.io/Nimby_Site/build_the_linear_model_step4.html)
