...
The third law of Tom Khabaza's [Nine Laws of Data Mining](http://khabaza.codimension.net/index_files/9laws.htm) states that "*Data preparation is more than half of every data mining process.*" Throughout this project, I embraced this maximum as I worked my way through the various data quality issues encountered. Data is messy, and it was my task to make sense out of it. Additionally, predicting the relationship between recreational cannabis legalization and crime rates no straightforward task. Even with careful consideration of data construction , an accruate predictive model takes trial and error, as well as an understanding of the many factors that go into crime rate.

In order to fully address the concerns surrounding the long term implications of legal recreational cannabis use, we need to look at the issue from multiple angles. After this experience, I am more inclined to trust the results of meta-analyses of existing studies than one sole research study. As for Michigan, if I were to attempt a similar study, I would take a completely different approach. Crime rates are influenced by so many factors, I would spend my time analyzing the dynamics in state revenue and how those funds are being spent and how the multiplicities benefited.
