...
Reviewing the summary output, there is more evidence that my model appears is a poor fit for the data, as it only explains about 1.9% of the variation in the dependent variable. The adjusted R-squared is negative,.
...
It's not so simple as X predicts Y. Findings the right model takes xyz. what I got out of this project:
