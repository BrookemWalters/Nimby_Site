...
5.  merges like variables with different column names together and overrides the N/As
6.  cleans up the business names, and classifies the observation drawn from the license number prefix
7.  finds missing business names and replaces the null values with features extracted matching license numbers
8.  finds the missing zips codes and replaces the null values with matching license numbers
